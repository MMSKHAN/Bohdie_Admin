...
function Bdage() {
 ...
 <div className="UserHeader Badage">
   ...
   <div className="BdageHeaderChild4"> <span>Email</span> </div>
   <div className="BdageHeaderChild5"> <span>level</span> </div>
   <div className="BdageHeaderChild6"> <span>badge</span> </div>
 </div>
